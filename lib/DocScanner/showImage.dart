...
import 'package:Cardzo/DocScanner/cropImage.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:image_size_getter/image_size_getter.dart';
import 'package:provider/provider.dart';

//display image class for editing,renaming,etc..
...
class _ShowImageState extends State<ShowImage> {
  ...
  //Display a default name of our document.
  void initState() {
  ...
  @override
  //back button interceptor, if press back button show a warning message
  void dispose() {
  ...
  //warning message when press button.
  ...
  //widget for color selecting there are 3 types of colors : original,whiteboard,Grayscale.
  ...
  //converting image to gray,white,original type.
